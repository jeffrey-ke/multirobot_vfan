...
class ClusterNode(Node):
    ...
    def handle_r0sensor(self, msg: Float32):
        self._r0_sensor_reading = msg.data
        self.calculate_c_vel()
        
    def handle_r1sensor(self, msg: Float32):
        self._r1_sensor_reading = msg.data
        self.calculate_c_vel()
    
    def handle_r2sensor(self, msg: Float32):
        self._r2_sensor_reading = msg.data
        self.calculate_c_vel()
